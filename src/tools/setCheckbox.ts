...
export const setCheckboxTool = (context: ToolContext) => tool({
    ...
    async execute({ reasoning, element_description, checked }): Promise<ToolOutput> {
        updateLog({ type: 'ui', kind: 'form', titleKey: 'ui.titles.checkbox', textKey: checked ? 'ui.texts.checkboxOn' : 'ui.texts.checkboxOff', text: '', params: { reasoning, element: element_description } });
